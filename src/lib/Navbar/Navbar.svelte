<script>
	...
	import scroll from 'svelte-scrolling'


	scroll.setGlobalOptions({
		duration: 1500
	})
</script>
	 ...
	 z-10'>
		<nav class='relative py-5 max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 font-header'
			...
			<div class='space-x-4 text-sm md:text-base md:space-x-10 flex items-center w-full'><a
				...
				<svg class='w-8 text-accent' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' stroke-width="2.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
