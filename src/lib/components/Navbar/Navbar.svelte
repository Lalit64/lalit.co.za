...
<div class='pt-28 font-semibold'>
	<div class='fixed top-0 left-0 w-full bg-transparent z-10 backdrop-blur-sm'>
		<nav class='relative py-5 max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 font-header'
			...
			</a><a class='text-gray-600 hover:text-accent transition duration-300' href='{base}/blog'>Articles</a><a
